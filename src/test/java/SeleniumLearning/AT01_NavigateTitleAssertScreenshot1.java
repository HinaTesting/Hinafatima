...
public class AT01_NavigateTitleAssertScreenshot1 {
    ...
    //Assertion
       Assert.assertEquals(ExpectedTitle,ActualTitle);
         //System.out.println("the expected title matches the actual title of homepage")
        // another version of assert
        Assert.assertTrue(ActualTitle.contains("Computers"));

        //screenshot
        File screenshotFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(screenshotFile, new File("C:\\Users\\hinan\\Desktop\\Testing Class Jagan\\screenshot.png"));
    }
}
